...
<script>
    ...
    function validateForm() {
        try {
            let productOptions = [];
            if (caller == "submitButton") {
                console.log("I am cart button")
                productOptions.push({
                    "buyProduct": false
                })
            } else if (caller == "submitButton2") {
                console.log("I am Buy product button")
                productOptions.push({
                    "buyProduct": true
                })
            }
            ...
            $("input[type=radio]:checked").each((elem, obj) => {
            ...
            $.ajax({
                ...
                dataType: 'html',
                data: {
                    jsonObject: JSON.stringify(productOptions),
                },
